...
let TrainsController = (() => {
    let _classDecorators = [(0, common_1.Controller)('trains')];
    ...
    var TrainsController = _classThis = class {
        constructor(trainsService) {
            this.trainsService = (__runInitializers(this, _instanceExtraInitializers), trainsService);
        }
        create(dto) {
    ...
    __setFunctionName(_classThis, "TrainsController");
    (() => {
        ...
        TrainsController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TrainsController = _classThis;
})();
